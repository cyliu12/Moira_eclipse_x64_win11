...
public class SaveControlDialog extends Dialog {
	private boolean backup, no_confirm_save;

	private String folder;

	private Text text;

	public SaveControlDialog(Shell parent) {
		super(parent);
	}
	...
	public Control createDialogArea(Composite parent) {
		...
		final Button no_confirm = new Button(parent, SWT.CHECK);
